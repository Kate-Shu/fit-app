  ...
  return (
    <main className="relative grid flex-grow md:grid-cols-2 h-full min-h-screen z-0 overflow-hidden md:mt-0">
      ...
      <section className="h-full flex flex-col pt-7 z-10">
        ...
        <Button variant='primary' className='ml-15 sm:ml-30 md:ml-40 lg:ml-50 xl:ml-60 mb-10 sm:mb-6 md:mb-9 lg:mb-11 xl:mb-15 gradient-frst'>Workouts</Button>
        <Button variant='primary' className='ml-15 sm:ml-40 md:ml-50 lg:ml-60 xl:ml-70 mb-10 sm:mb-6 md:mb-9 lg:mb-11 xl:mb-15 gradient-snd'>Dance</Button>
        <Button variant='primary' onClick={() => setOpenOverlay(true)} className='ml-15 xs:ml-0 sm:ml-50 md:ml-60 lg:ml-70 xl:ml-80 gradient-thrd'>AI assistant</Button>
      </section>
